...
namespace Event_Parking_Reservation_System.Interfaces
{
        ...
        public interface ICustomerAccountRepository
        {
            ...
            /// <summary>
            /// Persists the verified security state and lets Customer Management
            /// move an Unverified account to Active without Authentication directly
            /// depending on the Customer entity/status enum.
            /// </summary>
